...
public class CriAtomSource : CriAtomSourceBase
{
	 ...
	 * <remarks>
	 * <para header='説明'>CriAtomSource::Play 関数や CriWare.CriAtomSource.cueName プロパティで指定したキューは、
	 ...
	 * <remarks>
	 * <para header='説明'>どのキューを再生するかは、事前に CriWare.CriAtomSource.cueName
	 ...
	 * <summary>設定されているキューを再生開始します。</summary>
	 * <remarks>
	 * <para header='説明'>事前に CriAtomSource::playOnStart, CriWare.CriAtomSource.cueName
