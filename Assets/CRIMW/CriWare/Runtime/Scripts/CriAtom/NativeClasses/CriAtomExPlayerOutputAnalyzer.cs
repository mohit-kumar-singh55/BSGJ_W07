 ...
 * \deprecated
 * 削除予定の非推奨APIです。
 * CriWare.CriAtomExOutputAnalyzer クラスの使用を検討してください。
 ...
 * <para header='注意'>将来的に本クラスは廃止される予定です。 CriWare.CriAtomExOutputAnalyzer をご利用ください。<br/>
 * HCA-MXやプラットフォーム固有の音声圧縮コーデックを使用している場合は解析できません。<br/>
 * HCAもしくはADXコーデックをご利用ください。</para>
 * </remarks>
*/
[System.Obsolete("Use CriWare.CriAtomExOutputAnalyzer")]
